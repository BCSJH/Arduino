...
// OLED 디스플레이 선언
  ...
  void WIFI_data() {//와이파이 값 가져와서 제어
    ...
    if (s.available() > 0)
    {
      ...
      if ((ints != 0 & ints != 1 & ints != 2 & ints != 3 & ints != 4 & ints != 5 &  ints != 6 &ints != 9 & ints != 12 & ints != 15 & ints != ' ') & doit_count == 1)
      {
      ...
      if (news == "0" | news == "1" | news == "2" | news == "3" | news == "4" | news == "5" | news == "6" | news == "9" | news == "12" | news == "15")
      {
        WIFI_set += 1;
        Serial.print("WIFI");
